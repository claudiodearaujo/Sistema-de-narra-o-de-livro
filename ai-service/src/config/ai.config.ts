...
export const aiConfig: AIConfig = {
    defaultTextProvider: (process.env.TEXT_PROVIDER as TextProviderType) || 'gemini',
    defaultImageProvider: (process.env.IMAGE_PROVIDER as ImageProviderType) || 'gemini',
    defaultTTSProvider: (process.env.TTS_PROVIDER as TTSProviderType) || 'elevenlabs',
    providers: {
        gemini: {
        ...
        elevenlabs: {
            ...
            defaultModel: process.env.ELEVENLABS_MODEL_ID || 'eleven_multilingual_v2',
            voiceSettings: {
    ...
    storage: {
        audioPath: process.env.AUDIO_STORAGE_PATH || './storage/audio',
        cachePath: process.env.CACHE_STORAGE_PATH || './storage/cache'
    }
};
