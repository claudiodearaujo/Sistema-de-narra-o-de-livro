...
const oauthController = __importStar(require("../controllers/oauth.controller"));
...
router.post('/authorize', auth_middleware_1.authenticate, oauthController.authorize);
// Token endpoint - exchanges code for tokens (public)
router.post('/token', oauthController.token);
// UserInfo endpoint - returns user info (requires auth)
router.get('/userinfo', auth_middleware_1.authenticate, oauthController.userInfo);
