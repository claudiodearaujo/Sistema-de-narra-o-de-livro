...
exports.stopAuditCleanupWorker = stopAuditCleanupWorker;
/**
 ...
 */
function startAuditCleanupWorker() {
    if (cleanupInterval) {
 ...
 */
function stopAuditCleanupWorker() {
    if (cleanupInterval) {
...
async function runCleanup() {
    ...
    try {
        const deletedCount = await audit_service_1.auditService.purgeByRetentionPolicy();
